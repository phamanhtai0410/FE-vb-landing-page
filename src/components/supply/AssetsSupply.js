...
const AssetsSupply = () => {
    ...
    return (
        ...
        <div className="w-full min-h-max rounded-lg bg-[#141432] mt-16 p-10 fade-in-box">
            ...
            <h4 className="font-montserrat text-[30px] leading-9">Assets to supply</h4>
                ...
                <div className="p-2 flex flex-row justify-start items-center space-x-4 w-full text-right cursor-pointer bg-[#1B1A43]">
                    <div className="block">
                        <label className="inline-flex items-center cursor-pointer">
                            <input type="checkbox" defaultChecked={true} className="w-4 h-4 border-0 focus:ring-0" />
                            <span className="ml-4 font-poppins text-base leading-6">Show assets with 0 balance</span>
                        </label>
                    </div>
                </div>
