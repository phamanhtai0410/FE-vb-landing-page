            ...
            */}
            ...
            <div className="p-3 mt-5">
                ...
                <div className="p-2 flex flex-row justify-start items-center space-x-4 w-full text-right cursor-pointer bg-[#1B1A43]">
                    <div class="block">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" defaultChecked={true} class="w-4 h-4 border-0 focus:ring-0" />
                            <span class="ml-4 font-poppins text-base leading-6">Show assets with 0 balance</span>
                        </label>
                    </div>
                </div>
