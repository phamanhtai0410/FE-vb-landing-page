...
const Banner = () => {
    ...
    return (
        <div className="flex justify-center items-center relative max-w-max mx-auto max-w-fit">
            ...
            <div className="text-[#19FFFF] absolute w-full h-full flex flex-col justify-center items-center xl:mt-[-14rem] 3xl:mt-[-17rem]">
                <p className="font-nebula text-[30px] leading-10">The whole</p>
                <p className="font-blank_space text-[30px] leading-11">Vechain DeFi Ecosystem</p>
