...
const AssetsFarm = () => {
                ...
                >
                    <div>
                        ...
                        <div
                            ...
                            <div
                                className="p-4 col-span-3 flex flex-row justify-center items-center space-x-4 w-full text-right cursor-pointer">
                                <div className="flex -space-x-2 overflow-hidden">
                                    <img className="inline-block h-8 w-8 rounded-full" src={item.iconOrigin} alt=""/>
                                    <img className="inline-block h-8 w-8 rounded-full" src={item.iconAssets} alt=""/>
                                </div>
                        ...
                        <FarmRowAction key={item.assetsPoolAddress + '_act'} openRowAssets={openRowAssets} item={item}/>
    ...
    return (
        ...
        <div className="w-full min-h-max rounded-lg bg-[#0b1329] mt-10 p-10 fade-in-box">
            ...
            <h4 className="font-montserrat text-[20px] leading-9 text-[#3FDCA5]">Farms</h4>
                ...
                <div className="grid grid-cols-12 justify-items-center content-around font-poppins text-[14px]">
                    ...
                    </div>
                    {
                        ASSETS_FARM_HEADER.map((item) => (
                            <div className="px-2 py-2 col-span-2 flex items-center" key={item.key}>
                                <span>{item.text}</span>
                                {
                                    item.additionalInfo.isHaveInfo &&
                                    <img className='ml-2 w-3 h-3' src={IcInfoCircle} alt={IcInfoCircle}/>
                                }
                                <img className='ml-1' src={IcCaretDown} alt={IcCaretDown}/>
                            </div>
                        ))
