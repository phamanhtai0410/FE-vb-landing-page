...
const BorrowPage = () => {
  ...
  return (
    ...
    <section className="box-borrows mx-auto bg-cover bg-center" >
      ...
      <div className="container mx-auto lg:px-6 px-4 min-h-screen pt-16 mb-8">
        ...
        <div className="w-full min-h-max rounded-lg bg-[#141432] mt-16 p-10">
          ...
          <div className="bg-[#1B1A43] p-3 mt-5">
            ...
            <div className="p-2 flex flex-row justify-start items-center space-x-4 w-full text-right cursor-pointer">
